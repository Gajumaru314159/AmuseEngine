...
#pragma endregion
	...
	Ref<Buffer> indexBuffer;
	{
		...
		vertexBuffer->update(sizeof(vertices), vertices);
		indexBuffer->update(sizeof(indices), indices);
	}
