...
namespace Amuse::Core {
	...
	public:
		...
		static IntColor FromCode(u32 code, ColorCodeFormat format = ColorCodeFormat::Default);
	public:
        ...
        //! @brief 等価演算子
		constexpr bool operator == (const IntColor& another) const noexcept;
	...
	//! @brief 等価演算子
	constexpr bool IntColor::operator == (const IntColor& another) const noexcept {
		return
			r == another.r &&
			g == another.g &&
			b == another.b &&
