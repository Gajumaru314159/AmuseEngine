...
#define AMUSE_API_EXPORT __declspec(dllexport)
#define AMUSE_API_IMPORT __declspec(import)

// GCC
#elif defined(__GNUC__)
#define COMPILER_GCC

#define AMUSE_API_EXPORT __attribute__((dllexport))
#define AMUSE_API_IMPORT __attribute__((dllimport))
...
#define AMUSE_DEBUG 1
#else
#define AMUSE_DEBUG 0
#endif
...
// AMUSE_DEBUG
#ifdef AMUSE_DEBUG
#	define AMUSE_DEBUG_CONTEXT(...)		__VA_ARGS__
#else
#	define AMUSE_DEBUG_CONTEXT(...)		/**/
#endif
