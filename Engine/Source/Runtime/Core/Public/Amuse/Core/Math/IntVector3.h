...
//===============================================================
//! @cond
template <> struct std::formatter<Amuse::IntVec3, Amuse::Char> : std::formatter<Amuse::s32, Amuse::Char> {
    using base = std::formatter<Amuse::s32, Amuse::Char>;
    template<typename FormatContext>
    auto format(const Amuse::IntVec3& value, FormatContext& ctx) const {
