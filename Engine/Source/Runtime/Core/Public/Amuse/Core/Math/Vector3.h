...
//===============================================================
//! @cond
template <> struct std::formatter<Amuse::Core::Vec3, Amuse::Core::Char> : std::formatter<Amuse::Core::f32, Amuse::Core::Char> {
    using base = std::formatter<Amuse::Core::f32, Amuse::Core::Char>;
    template<typename FormatContext>
    auto format(const Amuse::Core::Vec3& value, FormatContext& ctx) const {
