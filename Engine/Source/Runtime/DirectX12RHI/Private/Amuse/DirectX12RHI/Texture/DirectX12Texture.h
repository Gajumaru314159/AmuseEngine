...
namespace Amuse::RHI {
    ...
    public:
        ...
        //! @brief      SRVを生成
        void createSRV(D3D12_CPU_DESCRIPTOR_HANDLE handle, const TextureViewDesc& viewDesc)const;

        //! @brief      UAVを生成
        void createUAV(D3D12_CPU_DESCRIPTOR_HANDLE handle, s32 mipSlice)const;

        //! @brief      UAVを生成
        void createUAV(D3D12_CPU_DESCRIPTOR_HANDLE handle, const TextureViewDesc& viewDesc)const;

        //! @brief      RTVを生成
        void createRTV(D3D12_CPU_DESCRIPTOR_HANDLE handle, const TextureSubresourceRange& range)const;

        //! @brief      DSVを生成
        void createDSV(D3D12_CPU_DESCRIPTOR_HANDLE handle, const TextureSubresourceRange& range)const;
