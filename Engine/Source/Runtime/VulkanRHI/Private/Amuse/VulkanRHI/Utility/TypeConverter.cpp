...
namespace Amuse::RHI {
	...
	vk::AccessFlags TypeConverter::Convert(BufferState state) {
		...
		case BufferState::CopySource:				return vk::AccessFlagBits::eTransferRead;
		case BufferState::CopyDest:					return vk::AccessFlagBits::eTransferWrite;
		}
		throw NotSupportedException();
	}
	...
	vk::ImageLayout TypeConverter::Convert(TextureState value) {
		...
		case TextureState::ResolveSource:	return vk::ImageLayout::eTransferSrcOptimal;
		case TextureState::ResolveDest:		return vk::ImageLayout::eTransferDstOptimal;
